...
export class ItemsResolver {
  ...
  findMine(@Args() args: FindManyItemArgs, @GetUser() user: GetUserType) {
  ...
  async findOne(
    ...
    return await this.itemsService.findOneByOwner(args.where.id, user.uid)
  }
  ...
  async updateItem(
    ...
    await this.itemsService.findOneByOwner(args.id, user.uid)
  ...
  async removeItem(
    ...
    await this.itemsService.findOneByOwner(args.where.id, user.uid)
